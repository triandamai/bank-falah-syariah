    ...
    >
      ...
      <v-card>
        <v-toolbar color="primary" dark>
          ...
          <v-toolbar-title>{{$t('Transaksi Simpanan Setor Tunai')}}</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
...
<script>
import { ACTION_TRANSACTION, TABUNGAN_SETOR_TUNAI} from "@/store"
...
export default {
  ...
  methods: {
    onSubmit(){
      ...
      this.$store.dispatch(ACTION_TRANSACTION,{payload:this.form,type:TABUNGAN_SETOR_TUNAI})
