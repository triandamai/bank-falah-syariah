  ...
  <div id="app">
    <v-app>
        ...
        <section id="about-me">
          ...
          <v-container class="text-center">
            ...
            >
              ...
              engaging web applications using the Material Design specification.
              It accomplishes that with a consistent update cycle, Long-term
              Support (LTS) for previous versions, responsive community
              engagement, a vast ecosystem of resources and a dedication to
              quality components.
            </v-responsive>
      ...
      <v-footer class="justify-center" color="#292929" height="100">
        ...
        >
          &copy; {{ new Date().getFullYear() }} — Axioma, LLC — Made with 💜 by
          Bakaran project
        </div>
      </v-footer>
    </v-app>
